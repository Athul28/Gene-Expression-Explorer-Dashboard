...
export default function LandingPage() {
  ...
  const datasets = [
    {
      ...
      description: "Comprehensive analysis of gene expression patterns in breast cancer subtypes",
      category: "cancer",
      samples: 1250,
      date: "2023-09-15",
    ...
    {
      id: 2,
      title: "COVID-19 Host Response",
      description: "Host transcriptional response to SARS-CoV-2 infection across severity levels",
      category: "covid",
      samples: 850,
      date: "2023-11-02",
      image: "/placeholder.svg?height=120&width=240",
    ...
    },
    {
      ...
      description: "Gene expression profiles from lung adenocarcinoma patients with clinical annotations",
      category: "cancer",
      samples: 780,
      date: "2023-08-20",
      image: "/placeholder.svg?height=120&width=240",
    ...
    {
      id: 4,
      title: "Common Cold Viral Response",
      description: "Transcriptional changes during rhinovirus infection in nasal epithelium",
      category: "cold",
      samples: 320,
      date: "2023-07-11",
      image: "/placeholder.svg?height=120&width=240",
    ...
    {
      id: 5,
      title: "COPD Progression Markers",
      description: "Longitudinal gene expression analysis of COPD progression and exacerbations",
      category: "lung",
      samples: 560,
      date: "2023-10-05",
      image: "/placeholder.svg?height=120&width=240",
    },
    {
      ...
      description: "Stage-specific gene expression signatures in colorectal cancer development",
      category: "cancer",
      samples: 680,
      date: "2023-09-28",
      image: "/placeholder.svg?height=120&width=240",
    ...
    {
      id: 7,
      title: "COVID-19 Variant Comparison",
      description: "Differential host response to major SARS-CoV-2 variants of concern",
      category: "covid",
      samples: 420,
      date: "2023-12-01",
      image: "/placeholder.svg?height=120&width=240",
    ...
    {
      id: 8,
      title: "Asthma Endotypes",
      description: "Transcriptional profiling of different asthma endotypes and treatment responses",
      category: "lung",
      samples: 490,
      date: "2023-08-14",
      image: "/placeholder.svg?height=120&width=240",
    },
    {
      ...
      description: "Molecular subtypes and treatment resistance patterns in glioblastoma",
      category: "cancer",
      samples: 380,
      date: "2023-11-19",
      image: "/placeholder.svg?height=120&width=240",
    },
    {
      ...
      description: "Comparative analysis of host response to different influenza strains",
      category: "cold",
      samples: 290,
      date: "2023-10-22",
      image: "/placeholder.svg?height=120&width=240",
    },
    {
      ...
      description: "Progressive gene expression changes in IPF with correlation to clinical outcomes",
      category: "lung",
      samples: 310,
      date: "2023-07-30",
      image: "/placeholder.svg?height=120&width=240",
    },
    {
      ...
      description: "Early detection biomarkers and progression signatures in pancreatic cancer",
      category: "cancer",
      samples: 340,
      date: "2023-12-10",
      image: "/placeholder.svg?height=120&width=240",
  ...
  const filteredDatasets = activeTab === "all" ? datasets : datasets.filter((dataset) => dataset.category === activeTab)
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/80 backdrop-blur-md">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link href="#datasets" className="text-sm font-medium text-gray-600 hover:text-teal-600 transition-colors">
              Datasets
            </Link>
            <Link
              href="#visualizations"
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 max-w-2xl">
                  Explore and visualize gene expression patterns across cancers, COVID-19, and respiratory diseases with
              ...
              <div className="flex items-center space-x-8 text-sm text-gray-600">
                <div className="flex items-center space-x-2">
                  <Badge variant="outline">12 Curated Datasets</Badge>
                </div>
                <div className="flex items-center space-x-2">
                  <Badge variant="outline">4 Disease Categories</Badge>
                </div>
                <div className="flex items-center space-x-2">
                    ...
                    {Array.from({ length: 100 }, (_, i) => (
                      <div
                        ...
                        className={`aspect-square rounded-sm ${
                          Math.random() > 0.7 ? "bg-red-500" : Math.random() > 0.4 ? "bg-yellow-400" : "bg-teal-500"
                        }`}
      ...
      <section id="datasets" className="py-16 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Explore 12 Handpicked Datasets</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Dive into curated gene expression datasets across multiple disease categories
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {filteredDatasets.map((dataset) => (
              <Card key={dataset.id} className="overflow-hidden transition-all duration-300 hover:shadow-lg">
                <div className="aspect-[2/1] relative bg-gray-100">
                  ...
                  />
                  {dataset.badge && (
                    <Badge className="absolute top-2 right-2 bg-teal-500 hover:bg-teal-600">{dataset.badge}</Badge>
                  )}
                </div>
                <CardHeader>
                ...
                <CardContent>
                  <div className="flex justify-between text-sm text-gray-600">
                    ...
                    <span>Updated: {new Date(dataset.date).toLocaleDateString()}</span>
                  </div>
                </CardContent>
      ...
      <section id="visualizations" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            <h2 className="text-3xl font-bold text-gray-900">Interactive Visualizations & Predictions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Transform complex genomic data into actionable insights with our suite of visualization tools
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <Card className="overflow-hidden">
              <CardHeader>
                ...
                <CardDescription>
                  Visualize expression patterns across samples and conditions with hierarchical clustering
                </CardDescription>
              </CardHeader>
              ...
              <CardFooter className="bg-gray-50 px-6 py-4">
                <Button variant="outline" className="text-teal-600 hover:text-teal-700 hover:bg-teal-50">
            ...
            <Card className="overflow-hidden">
              <CardHeader>
                ...
                <CardDescription>
                  Identify significantly differentially expressed genes between conditions
                </CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="aspect-[4/3] bg-white rounded-lg p-4 border">
            ...
            <Card className="overflow-hidden">
              <CardHeader>
                ...
                <CardDescription>Predict patient outcomes based on gene expression signatures</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="aspect-[4/3] bg-white rounded-lg p-4 border">
                  <div className="h-full flex items-center justify-center">
            ...
            <Card className="overflow-hidden">
              <CardHeader>
                ...
                <CardDescription>Identify biological pathways affected in disease conditions</CardDescription>
              </CardHeader>
              <CardContent className="p-6">
                <div className="aspect-[4/3] bg-white rounded-lg p-4 border">
                  <div className="h-full flex flex-col">
                    <div className="flex-1 space-y-3">
                      {[
                        { name: "Immune Response", value: 0.85, color: "bg-teal-500" },
                        { name: "Cell Cycle Regulation", value: 0.72, color: "bg-cyan-600" },
                        { name: "Apoptosis", value: 0.68, color: "bg-sky-500" },
                        { name: "DNA Repair", value: 0.61, color: "bg-blue-500" },
                        { name: "Metabolism", value: 0.53, color: "bg-indigo-500" },
                        { name: "Signal Transduction", value: 0.47, color: "bg-purple-500" },
                        { name: "Angiogenesis", value: 0.39, color: "bg-pink-500" },
                      ].map((pathway, index) => (
                        <div key={index} className="space-y-1">
                          <div className="flex justify-between text-sm">
                            <span>{pathway.name}</span>
                            <span className="font-medium">p={pathway.value.toFixed(2)}</span>
                          </div>
      ...
      <section id="contribute" className="py-16 bg-gradient-to-br from-gray-900 to-gray-800 text-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-12">
            ...
            <h2 className="text-3xl font-bold">Contribute to Gene Expression Explorer</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Help expand our collection of visualized datasets and improve the platform
            </p>
          </div>
              ...
              <Card className="bg-white/10 border-0 text-white">
                ...
                <CardContent className="space-y-4">
                  <p className="text-sm text-gray-300">
                    Our team will review your submission and provide feedback. Once approved, your dataset will be
                    available to researchers worldwide.
                  </p>
                  <div className="flex items-center gap-2 text-sm">
                    <Star className="h-4 w-4 text-yellow-400" />
                    <span className="text-gray-300">Join our 120+ contributors</span>
                  </div>
                </CardContent>
              </Card>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-teal-500 to-cyan-600">
        <div className="container mx-auto px-4 md:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-6">
            <h2 className="text-3xl font-bold text-white">Ready to Explore Gene Expression Data?</h2>
            <p className="text-xl text-teal-50">
              Join researchers worldwide using Gene Expression Explorer to unlock genomic insights
            </p>
          ...
          <div className="grid gap-8 md:grid-cols-4">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">Gene Expression Explorer</span>
              </div>
              <p className="text-sm">
